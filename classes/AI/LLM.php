...
First, please output, on a line by itself without a header, a comma-separated list of the top 20
keywords or key phrases, that would help someone find the text to be summarized,
among a large corpus of text. At the end of this list, on the same line, continue to add
30-40 more comma-separated, common keywords that people are most likely to search for as well,
when specifically looking for this content, such as synonyms. Do not include bold headers.
HEREDOC;
        $summaryInstructions = <<<HEREDOC
Then, accurately summarize the content, in one single cohesive and easy-to-follow paragraph.
...
Finally, if the text clearly says who the speakers are, please list their names separated by commas. Otherwise write "no names".
HEREDOC;
...
HEREDOC;
        ...
        $completions = $this->chatCompletions($messages);
